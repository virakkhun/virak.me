...
{#if visitorMessages}
	<div class:bg-yellow-900={!isEmpty} class="flex flex-col gap-3 items-start my-4 rounded-md p-4">
		{#each visitorMessages as vm}
			<div class="flex md:items-center items-start md:gap-2 md:flex-row flex-col">
				...
				<span class="font-bold italic md:text-xl text-lg">"{vm.message}"</span>
				<div>
